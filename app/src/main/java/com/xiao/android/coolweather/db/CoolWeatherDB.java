package com.xiao.android.coolweather.db;
...
public class CoolWeatherDB {
    ...
    public static CoolWeatherDB getInstance(Context context) {
        return sCoolWeatherDB == null ? new CoolWeatherDB(context) : sCoolWeatherDB;
    }

    /**
     * 将 Province 实例存储到数据库中
     */
    ...
    public List<Province> loadProvinces() {
        ...
        if (cursor != null) {
            cursor.close(); // 开发中注意：cursor 使用后应关闭
        }
    ...
    public List<County> loadCounties(int cityId) {
        ...
        Cursor cursor = mDb.query("County", null,
